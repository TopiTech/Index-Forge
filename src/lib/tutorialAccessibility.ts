...
export const TUTORIAL_KEYBOARD_SHORTCUTS: readonly KeyboardShortcutHelp[] = [
  ...
  { key: "↑ / W", label: "カメラを上に仰角回転", category: "3d_camera" },
  { key: "↓ / S", label: "カメラを下に俯角回転", category: "3d_camera" },
  { key: "← / A", label: "カメラを左に回転", category: "3d_camera" },
  { key: "→ / D", label: "カメラを右に回転", category: "3d_camera" },
  { key: "+ / =", label: "カメラをズームイン", category: "3d_camera" },
  { key: "- / _", label: "カメラをズームアウト", category: "3d_camera" },
  { key: "R", label: "視点を初期位置にリセット", category: "3d_camera" },
  { key: "Space", label: "自動回転の一時停止 / 再開", category: "3d_camera" },
